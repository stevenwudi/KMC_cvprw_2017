import keras
from models.CNN import cnn_hiararchical_batchnormalisation, l1_smooth_loss
...
def main():
    ...
    gen = Generator(batch_size=32,
                    filename="./data/OTB100_tensorflow_new_%d.hdf5",
    ...
    callbacks = [keras.callbacks.ModelCheckpoint('./checkpoints/weights.{epoch:02d}-{val_loss:.4f}.hdf5',
                                                 verbose=1,
